  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Update / Pengumuman</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content" style="padding-bottom: 40px;">
      <form action="services/proses_pengumuman.php?aksi=edit_pengumuman&id=<?= $id ?>" method="POST" enctype="multipart/form-data">
        <div class="row">
          <div class="col-md-9">
            <div class="card card-primary">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" id="inputName" placeholder="Judul Pengumuman" name="judulPengumuman" required="" autofocus="" class="form-control" value="<?= $row['judul_pengumuman']; ?>">
                </div>
                <div class="form-group">
                  <textarea id="summernote" name="isiPengumuman" required>
                    <?= $row['isi_pengumuman']; ?>
                  </textarea>
                </div>
              </div>
            ...
            <div class="card card-secondary">
              ...
              <div class="card-body">
                <div class="form-group">
                  <label>Date:</label>
                    <?php
                        $tanggal    = $row['tanggal_pengumuman'];
                        $newDate    = date("m/d/Y", strtotime($tanggal));
                      ?>
                    <div class="input-group date" id="reservationdate" data-target-input="nearest">
                        <input type="text" class="form-control datetimepicker-input" data-target="#reservationdate"  name="tanggalPengumuman" value="<?= $newDate; ?>" required/>
                ...
                <div class="form-group">
                  ...
                  <?php 
                        $status = $row['status_pengumuman'];
                        if($status != 0){
                          echo "<select id='inputStatus' class='form-control custom-select' name='statusPengumuman' required>";
                ...
                <div class="form-group">
                  <label for="customFile">File Pengumuman<small><em> Max</em> 15 MB (PDF)</small></label>
                  <div class="custom-file">
                    <input type="file" class="custom-file-input" id="customFile" name="filePengumuman" value="<?= $row['file_pengumuman'] ?>">
                    <label class="custom-file-label" for="customFile"><?= $row['file_pengumuman'] ?></label>
                  </div>
                </div>
              </div>
              <!-- /.card-body -->
        ...
        <div class="row">
          <div class="col-12">
            ...
            <input type="submit" value="Update News" class="btn btn-success btn-lg float-right" name="upload">
          </div>
        </div>
      </form>
    </section>
