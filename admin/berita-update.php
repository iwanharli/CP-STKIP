...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content" style="padding-bottom: 40px;">
      <form action="services/proses_berita.php?aksi=edit_berita&id=<?= $id ?>" method="POST" enctype="multipart/form-data">
        <div class="row">
            <div class="col-md-9">
              <div class="card card-primary">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" id="inputName" placeholder="Judul Berita" name="judulBerita" required="" autofocus="" class="form-control" value="<?= $row['judul_berita'] ?>" required>
                  </div>
                  <div class="form-group">
                ...
                <div class="card-body">
                  <div class="form-group">
                    <label>Date:</label>
                      ...
                      <div class="input-group date" id="reservationdate" data-target-input="nearest">
                          <input type="text" class="form-control datetimepicker-input" data-target="#reservationdate" name="tanggalBerita" value="<?= $newDate; ?>" required/>
                  ...
                  <div class="form-group">
                    <label for="inputStatus">Status</label>
                      <?php 
                        $status = $row['status_berita'];
                        if($status != 0){
                          echo "<select id='inputStatus' class='form-control custom-select' name='statusBerita' required>";
                  ...
                  <div class="form-group">
                    ...
                    <div class="custom-file">
                      <input type="file" class="custom-file-input" id="customFile" name="coverBerita">
                      <label class="custom-file-label" for="customFile"><?= $row['cover_berita'] ?></label>
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="inputSpentBudget">Author</label>
                    <input type="text" class="form-control" name="penulisBerita" value="<?= $row['penulis_berita'] ?>" required>
                  </div>
                  <div class="form-group">
                    <label for="inputStatus">Category</label>
                    <select id="inputStatus" class="form-control custom-select" name="kategoriBerita" required>
                      <option> -- Pilih Kategori -- </option>
                      <option style="display:none;" value="<?= $row['kategori_berita']; ?>" selected><?= $row['kategori_berita']; ?></option>
                  ...
                  <div class="form-group">
                      ...
                      <div class="select2-purple">
                        <select class="select2" name="tagsBerita" multiple="multiple" data-placeholder="Select a Tags" data-dropdown-css-class="select2-purple" style="width: 100%;">
                          <option style="display:none;" value="<?= $row['tags_berita']; ?>" selected><?= $row['tags_berita']; ?></option>
        ...
        <div class="row">
          <div class="col-12">
            ...
            <input type="submit" class="btn btn-success btn-lg float-right" name="upload" value="Update News">
          </div>
        </div>
      </form>
    </section>
