    ...
    <div class="sidebar">
      ...
      <li class="nav-item menu-open">
        ...
        <ul class="nav nav-treeview">
              ...
              <ul class="nav nav-treeview">
    						<li class="nav-item">
    							<a href="pengumuman-add-post.php" class="nav-link active" id="link-small">
                    <i class="far fa fa-plus nav-icon" aria-hidden="true" style="color:#13cc13;"></i>
    							  <p>Add Post</p>
    							</a>
    						</li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Add Post / Pengumuman</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content" style="padding-bottom: 40px;">
      <form action="services/proses_pengumuman.php" method="POST" enctype="multipart/form-data">
        <div class="row">
            <div class="col-md-9">
              <div class="card card-primary">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" id="inputName" placeholder="Judul Pengumuman" name="judulPengumuman" required="" autofocus="" class="form-control">
                  </div>
                  <div class="form-group">
              ...
              <div class="card card-secondary">
                ...
                <div class="card-body">
                  <div class="form-group">
                    <label>Date:</label>
                      <div class="input-group date" id="reservationdate" data-target-input="nearest">
                          <input type="text" class="form-control datetimepicker-input" data-target="#reservationdate"  name="tanggalPengumuman" required/>
                  ...
                  <div class="form-group">
                    ...
                    <select id="inputStatus" class="form-control custom-select" name="statusPengumuman" required>
                  ...
                  <div class="form-group">
                    ...
                    <div class="custom-file">
                      <input type="file" class="custom-file-input" id="customFile" name="filePengumuman" required>
        ...
        <div class="row">
          <div class="col-12">
            ...
            <input type="submit" value="Create News" class="btn btn-success btn-lg float-right" name="tambah_pengumuman" required>
          </div>
        </div>
      </form>
    </section>
