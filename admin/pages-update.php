...
$menu       = mysqli_query($koneksi, "SELECT * FROM menu m JOIN menu_detail md ON m.id_menuDetail=md.idMenuDetail WHERE m.idMenu='$id'");
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content" style="padding-bottom: 40px;">
      <form action="services/proses_pages.php?aksi=edit_pages&id=<?= $id ?>" method="POST" enctype="multipart/form-data">
        <div class="row">
            <div class="col-md-9">
              <div class="card card-primary">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" id="inputName" name="namaMenu" required="" autofocus="" class="form-control" value="<?= $row['nama_menu'] ?>" disabled>
                  </div>
                  <div class="form-group">
                    <textarea id="summernote" name="isiMenuDetail" required>
                      <?= $row['isi_detail'] ?>
                    </textarea>
                  </div>
                </div>
              ...
              <div class="card card-secondary">
                ...
                <div class="card-body">
                  <div class="form-group">
                    <label>Date:</label>
                      <?php
                        $tanggal = $row['tanggal_detail'];
                        $newDate    = date("m/d/Y", strtotime($tanggal));
                      ?>
                      <div class="input-group date" id="reservationdate" data-target-input="nearest">
                          <input type="text" class="form-control datetimepicker-input" data-target="#reservationdate" name="tanggalDetail" value="<?= $newDate; ?>" required/>
                  ...
                  <div class="form-group">
                    <label for="customFile">Isi Gambar<small><em> Max</em> 3 MB</small></label>
                    <div class="custom-file">
                      <input type="file" class="custom-file-input" id="customFile" name="gambarDetail">
                      <label class="custom-file-label" for="customFile"><?= $row['gambar_detail'] ?></label>
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->
