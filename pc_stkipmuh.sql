...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 01, 2022 at 11:28 AM
...
CREATE TABLE `menu` (
  ...
  `id_menuDetail` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `menu` (`idMenu`, `nama_menu`, `detail_menu`, `level_menu`, `id_menuDetail`) VALUES
(1, 'Home', 'Halaman Utama', 1, NULL),
(2, 'Profil', NULL, 1, NULL),
(3, 'Pendaftaran Mahasiswa Baru', NULL, 1, 4),
(4, 'Prodi Bahasa & Sastra', NULL, 1, 5),
(5, 'Jurnal', NULL, 1, NULL),
(6, 'Mahasiswa & Alumni', NULL, 1, 6),
(7, 'Informasi', NULL, 1, NULL),
(8, 'Visi Misi', NULL, 2, 1),
(9, 'Struktur Organisasi', NULL, 2, 2),
(10, 'Tujuan', NULL, 2, 3);
...
INSERT INTO `menu_detail` (`idMenuDetail`, `isi_detail`, `gambar_detail`, `tanggal_detail`) VALUES
(1, '                                                                  <h5 class=\"\"><p class=\"\"></p><p class=\"\"></p></h5><h2 class=\"\"><p class=\"\"></p></h2><h6 class=\"\"><p class=\"\"></p><ul><li>Menyelenggarakan pendidikan dan pembelajaran yang selaras dengan perkembangan Iptek terkini.</li></ul><ul><li>Menyelenggarakan Tridharma perguruan tinggi yang berkontribusi pada inovasi dan pengembangan tekhnologi pendidikan.</li></ul><ul><li>Menyelenggarakan kerjasama dan tata kelola lembaga dengan prinsip good corporate governance.</li></ul><ul><li>Menyelenggarakan pembudayaan nilai-nilai keislaman bagi seluruh civitas akademika yang berpedoman pada matan, keyakinan, cita-cita dan pedoman hidup islami Muhammadiyah.</li></ul><p></p></h6><p></p><p></p><p></p>                                                            ', 'logo-st.png', '2022-12-02'),
(2, 'test2', 'test2', '2022-12-01'),
(3, 'test3', 'test3', '2022-12-01'),
(4, 'test4', 'test4', '1900-01-01'),
(5, 'test5', 'test5', '1900-01-01'),
(6, 'test6', 'test6', '1930-01-01');
...
--
ALTER TABLE `menu_detail`
  MODIFY `idMenuDetail` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
